...
from .driver import PlaywrightUnicomDriver, UnicomDriverFactory
from .parser import (
    PageContractError,
...
class ChinaUnicomAdapter(PlatformAdapter):
    """Experimental public-announcement adapter for China Unicom."""

    def __init__(
        self,
        descriptor: PlatformDescriptor,
        *,
        driver_factory: UnicomDriverFactory | None = None,
        headless: bool = True,
        timeout_ms: int = 45_000,
        user_data_dir: Path | None = None,
    ) -> None:
        self.descriptor = descriptor
        self.profile = CHINA_UNICOM_PROFILE
        self.driver_factory = driver_factory or (
            lambda: PlaywrightUnicomDriver(
                self.profile,
                headless=headless,
